        ...
        {queue.length > 1 && (
          <>
            <button
              ...
              className="hidden sm:flex absolute left-1 top-[7.5rem] -translate-y-1/2 size-9 rounded-full bg-white/90 hover:bg-white shadow items-center justify-center text-stone-600 disabled:opacity-30 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              className="hidden sm:flex absolute right-1 top-[7.5rem] -translate-y-1/2 size-9 rounded-full bg-white/90 hover:bg-white shadow items-center justify-center text-stone-600 disabled:opacity-30 disabled:cursor-not-allowed"
            >
      ...
      <div className="flex gap-2 overflow-x-auto scrollbar-hide pb-1">
        {queue.map((item, idx) => (
          <button
            ...
            className={cn(
              "relative size-14 rounded-xl overflow-hidden flex-shrink-0 bg-stone-100 transition-all",
              idx === activeIndex
          ...
          >
            {item.status === "done" ? (
              ...
              <div className="size-full flex items-center justify-center bg-rose-50">
        ...
        <button
          ...
          className="size-14 rounded-xl flex-shrink-0 border-2 border-dashed border-stone-200 hover:border-rose-300 hover:bg-rose-50/30 flex items-center justify-center text-rose-300 transition-colors"
        >
    ...
    <div className="snap-center flex-shrink-0 w-full pr-3 last:pr-0 first:pl-0 space-y-3">
      ...
      <div className="aspect-video rounded-[2rem] overflow-hidden relative bg-stone-100">
        {item.status === "done" ? (
          ...
          <div className="size-full flex flex-col items-center justify-center text-rose-500 gap-1">
        ...
        <button
          ...
          className="absolute top-3 right-3 size-8 rounded-full bg-black/40 backdrop-blur-sm hover:bg-black/60 flex items-center justify-center text-white transition-colors"
        >
          <X className="size-4" />
        </button>
      </div>
      ...
      >
        <div
          className={`size-10 rounded-xl flex items-center justify-center ${item.isMajor ? "gradient-bg" : "bg-stone-200"}`}
        >
